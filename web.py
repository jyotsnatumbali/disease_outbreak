...
diabetes_model=pickle.load(open(r"C:\Users\jyots\OneDrive\Dokumen\Project_2025\training_models\diabetes_model.sav",'rb'))
heart_model=pickle.load(open(r"C:\Users\jyots\OneDrive\Dokumen\Project_2025\training_models\heart_model.sav",'rb'))
parkinsons_model=pickle.load(open(r"C:\Users\jyots\OneDrive\Dokumen\Project_2025\training_models\parkinsons_model.sav",'rb'))
...
if selected == 'Heart Disease Prediction':
    ...
    with col3:
        fbs = st.selectbox('Fasting Blood Sugar (fbs)', ['Yes', 'No'])   
    with col1:
